...
urlpatterns = [
    ...
    path('canchas/<int:cancha_id>/disponibilidad/', views.disponibilidad_cancha, name='disponibilidad_cancha'),
    path('canchas/<int:cancha_id>/horarios/', views.gestionar_horarios_cancha, name='gestionar_horarios_cancha'),
    ...
    path('api/canchas/<int:cancha_id>/horarios-disponibles/', views.api_horarios_disponibles, name='api_horarios_disponibles'),
